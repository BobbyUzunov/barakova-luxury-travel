...
export const contentBg = {
  ...
  cruisesSection: {
    ...
    description:
      "Предложения за морски пътувания с внимателно подбрани маршрути, красиви спирки и комфорт на борда.",
  },
  cruises: [
    {
      name: "Средиземноморски круиз",
      description:
        "Италия, Франция и Испания с елегантен морски ритъм.",
      image:
    ...
    },
    {
      name: "Гръцки острови",
      description:
        "Синьо море, островна атмосфера и романтични гледки.",
      image:
    ...
    },
    {
      name: "Карибски круиз",
      description:
        "Плажове, топъл океан и различни островни преживявания.",
      image:
        "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=88",
      detail:
    ...
    },
    {
      ...
      description:
        "Величествена природа, тишина и впечатляващи гледки.",
      image:
    ...
    },
    {
      ...
      description:
        "Модерен лукс, градски силуети и топли морски маршрути.",
      image:
        "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1200&q=88",
      detail:
    ...
    },
    {
      name: "Япония и Азия",
      description:
        "Култура, модерни градове и внимателно подбрани спирки.",
      image:
        "https://images.unsplash.com/photo-1528164344705-47542687000d?auto=format&fit=crop&w=1200&q=88",
      detail:
  ...
  blogSection: {
    ...
    description:
      "Истории, идеи и практически насоки от личния опит на Богдана Баракова.",
  },
  blog: {
    ...
    posts: [
      {
        ...
        excerpt:
          "Малки детайли, които често правят разликата между хубава почивка и преживяване, което остава в спомените.",
        image:
      ...
      },
      {
        ...
        excerpt:
          "Какво е важно да знаете преди да изберете остров, вила и тип преживяване на Малдивите.",
        image:
          "https://images.unsplash.com/photo-1573843981267-be1999ff37cd?auto=format&fit=crop&w=1200&q=88",
        date: "Скоро",
        category: "Дестинации",
      ...
      },
      {
        ...
        excerpt:
          "Персоналният маршрут спестява време, намалява хаоса и прави пътуването по-спокойно и смислено.",
        image:
